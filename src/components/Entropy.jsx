...
class Entropy extends Component {
  ...
  seed(e) {
    ...
    else if (_state.seedCount < _state.seedLimit && e && timeDiff > 40) {
  ...
  mergeTypedArrays(a, b) {
    ...
    if (!a && !b)
      console.error("Please specify valid arguments for parameters a and b.");
  ...
  getSeedingProgress() {
    const _state = this.props.getEntropy();
    return Math.trunc((_state.seedCount * 100) / _state.seedLimit);
  }
      ...
      <Col xs={12} id="Entropy">
        <Row className="r3">
          <Col>
            ...
            />
            <div id="seedMouseBox" onMouseMove={e => this.seed(e)}>
              <p>Move your mouse around to generate randomness</p>
            </div>
            <div>
              <FormGroup controlId="formControlsTextarea">
                <ControlLabel>
                  ... or type random letters and numbers here:
                </ControlLabel>
                <FormControl
                  type="text"
